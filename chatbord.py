...
#import dataset
lines=open('/home/sgb/Desktop/movies_dataset/movie_lines.txt',encoding='utf-8',errors='ignore').read().split('\n')
conversations=open('/home/sgb/Desktop/movies_dataset/movie_conversations.txt',encoding='utf-8',errors='ignore').read().split('\n')
...
#creating a lsit of all of the conersation
conversations_ids=[]
for conversation in conversations[:-1]:
    conversation=conversation.split(' +++$+++ ')[-1][1:-1].replace("'","").replace(" ","")
    conversations_ids.append(conversation.split(','))
...
#Creating placeholder for the inputs and targets
